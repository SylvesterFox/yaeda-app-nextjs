...
export default function Main() {
    return (
        <main className="max-w-[1920px] h-[842px] mx-auto px-[290px] flex justify-center bg-[var(--main-color)] rounded-b-[48px] drop-shadow-lg ">
            ...
            <div className="flex flex-row items-end justify-center">
                <img src="/main-image.png" alt="Main Image" className="w-[743px] h-[743px] relative rounded-lg drop-shadow-[-29px_0px_38.5px_rgba(0,0,0,0.25)]" />
            </div>
        </main>
    )
}